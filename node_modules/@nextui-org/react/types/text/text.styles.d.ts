...
export declare const StyledText: import("@stitches/react/types/styled-component").StyledComponent<"p", import("@stitches/react/types/styled-component").StyledComponentProps<[{
    variants: {
        weight: {
            hairline: {
                fontWeight: string;
